...
import styles from 'components/User/Profile/userprofile.style'
  ...
  render () {
    ...
    return (
      <Paper style={styles.paper} zDepth={4}>
        ...
        <Tabs initialSelectedIndex={this.state.section === 'preferences' ? 1 : 0}>
          ...
          <Tab label='Preferences' onClick={this.handleBrowsePreferencesAction}>
            <List style={styles.list}>
              ...
              <ListItem style={styles.item} primaryText='Delete account' leftIcon={<RemoveIcon />} />
            </List>
            <Dialog
              title='Edit profile'
              label='Profile'
