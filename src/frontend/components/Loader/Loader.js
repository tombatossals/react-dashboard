...
const POINTS = {
  A: (1.5 * SMALL_RADIUS * Math.PI) / LENGTH,
  B: (1.5 * SMALL_RADIUS * Math.PI + SMALL_RADIUS + LARGE_RADIUS) / LENGTH,
  C: (1.5 * (SMALL_RADIUS + LARGE_RADIUS) * Math.PI + SMALL_RADIUS + LARGE_RADIUS) / LENGTH,
};
